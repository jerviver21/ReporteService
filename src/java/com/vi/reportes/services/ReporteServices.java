 ...
 */
@Stateless
public class ReporteServices implements ReporteServicesLocal {
    ...
    @Override
    public void create(Reporte entity) throws LlaveDuplicadaException{
        try {
            em.persist(entity);
    ...
    @Override
    public void edit(Reporte entity) throws LlaveDuplicadaException{
        try {
            em.merge(entity);
        } catch (ConstraintViolationException e) {
            throw new LlaveDuplicadaException("El registro ya existe");
    ...
    @Override
    public void remove(Reporte group){
